...
sed -i "s/your-model/$MODEL/g" .env
```
...
```
 ...
 agents-cli deploy \
   ...
   --region us-central1 \
   --interactive \
   --update-env-vars GOOGLE_GENAI_USE_VERTEXAI=1,GOOGLE_CLOUD_LOCATION=global,GEMINI_MODEL=${MODEL},GOOGLE_CLOUD_AGENT_ENGINE_ENABLE_TELEMETRY=true,OTEL_SEMCONV_STABILITY_OPT_IN=gen_ai_latest_experimental,OTEL_INSTRUMENTATION_GENAI_CAPTURE_MESSAGE_CONTENT=EVENT_ONLY
 ```
